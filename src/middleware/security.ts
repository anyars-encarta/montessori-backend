  ...
  try {
    ...
    switch (role) {
      case "admin":
        limit = 100;
        message =
          "Admin request limit exceeded (100 per minute). Slow down, admin! Please wait before making another request.";
        break;
      case "teacher":
      case "staff":
        limit = 60;
        message =
          "User request limit exceeded (60 per minute). Please wait before making another request.";
        break;
      default:
        limit = 20;
        message =
